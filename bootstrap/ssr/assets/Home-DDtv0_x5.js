...
function Stats() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "dot-grid-light pointer-events-none absolute inset-0 opacity-50",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ jsx("div", {
				className: "pointer-events-none absolute -top-24 left-1/3 h-64 w-[36rem] max-w-none rounded-full bg-brand-600/20 blur-3xl",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ jsx("div", {
...
function ClientTile({ c, n }) {
	return /* @__PURE__ */ jsxs("a", {
		...
		children: [/* @__PURE__ */ jsx("span", {
			className: "shrink-0 font-mono text-xs text-brand-600",
			...
			loading: "lazy",
			decoding: "async",
			className: "max-h-12 max-w-[72%] object-contain"
			...
			loading: "lazy",
			decoding: "async",
			className: "h-10 w-10 shrink-0 rounded-lg border border-ink/10 object-contain p-1"
		}), /* @__PURE__ */ jsx("span", {
			className: "text-sm font-bold leading-snug text-ink/70 transition-colors group-hover:text-ink",
			children: c.name
		})] })]
	});
}
function ClientMarquee({ clients }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		className: "relative overflow-hidden border-t border-ink/10 section-gradient-subtle",
		children: [
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("div", {
				className: "container-site relative pt-16",
...
function Services({ services }) {
	...
	const buildHref = (path) => localizedPath(locale, path);
	return /* @__PURE__ */ jsxs("section", {
		className: "section-pad relative overflow-hidden section-gradient-subtle",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "dot-grid pointer-events-none absolute inset-0 opacity-40",
				"aria-hidden": "true"
			...
			/* @__PURE__ */ jsx("div", {
				className: "pointer-events-none absolute -top-24 right-0 h-72 w-72 rounded-full bg-brand-600/10 blur-3xl",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "container-site relative",
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [imgSrc ? /* @__PURE__ */ jsx("img", {
											...
											className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/65 via-black/20 to-transparent p-5",
											children: /* @__PURE__ */ jsx("span", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", {
											className: "font-mono text-[11px] uppercase tracking-[0.14em] text-ink/40 transition-colors group-hover:text-brand-600",
...
function Why() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "pointer-events-none absolute -top-32 right-0 h-80 w-80 rounded-full bg-brand-600/10 blur-3xl",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "container-site relative",
				children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeading, {
					...
					children: WHYS.map((w, i) => /* @__PURE__ */ jsx(Reveal, {
						delay: i * 120,
						children: /* @__PURE__ */ jsxs("div", {
							className: "flex h-full flex-col rounded-2xl border border-ink/10 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-600/40 hover:shadow-xl hover:shadow-brand-600/10 sm:p-10",
							children: [
								/* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsx("h3", {
									className: "mt-10 text-2xl font-bold leading-tight text-ink sm:mt-12",
...
function FieldStrip() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			className: "container-site section-pad relative",
...
function TestMenu({ menu }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			className: "pointer-events-none absolute -left-32 top-0 h-80 w-80 rounded-full bg-brand-100/60 blur-3xl",
			"aria-hidden": "true"
		}), /* @__PURE__ */ jsxs("div", {
			className: "container-site relative",
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeading, {
...
function InsightsTeaser({ insights }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				className: "pointer-events-none absolute -right-32 bottom-0 h-80 w-80 rounded-full bg-brand-600/10 blur-3xl",
				"aria-hidden": "true"
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "container-site relative",
...
//# sourceMappingURL=Home-DDtv0_x5.js.map